...
initialize();
    ...
    public static void initialize() {
        ...
        courses.add(new Course("programing", "introdaction to java programing ", "danial book java","osama", "C008"));
        courses.add(new Course("logic", "introdaction to logic ", "roth 9th edition","osama", "K203"));
